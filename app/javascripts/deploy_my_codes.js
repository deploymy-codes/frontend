require.register('deploy_my_codes', function(exports, require, module){
  module.exports = function() {
    ...
    angular.module('DeployMyCodes', ['foundation', 'localstorage', 'mm.foundation', 'ngResource', 'ui.router'])
           ...
           .service('OrganizationRepository', ['$http', '$q', 'APIHelper', require('deploy_my_codes/repositories/organization_repository')])
           ...
           .controller('AddProjectController', ['$scope', 'OrganizationService', 'ProjectService', 'UserService', require('deploy_my_codes/controllers/add_project_controller')])
  };
});
